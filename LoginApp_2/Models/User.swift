...
struct Person {
    ...
    static func getPerson() -> Person {
        Person(
            ...
            surname: "Кригин",
            age: "36",
            hobbie: "ios программирование, бег, естественные науки",
            job: "юриспруденция",
            bio: """
            ...
            За свою карьеру Павел сменил несколько направлений деятельности, был
            пограничником, работал менеджером по продажам, последние 7 лет работает
